<?php
/* 
Template Name: ПРОТЕЗИРОВАНИЕ - Общая информация
*/
?>
        ...
        <div class="page-content__container container">
            ...
            <section class="page-contetn__wrapper" id="content-page">
                ...
                <div class="page-content__chapter">
                    <div class="page-content__banner page-content__banner_protezirovanie">
                        <div class="page-content__name">Протезирование <br>в "Зубки Всем" </div>
                    ...
                    <div class="page-content__text">Съемное и несъемное протезирование зубов клиника «Зубки Всем» выполняет современными материалами на передовом оборудовании. Наша зуботехническая лаборатория находится в ТОП-10 лабораторий Москвы. Наши стоматологи-профессионалы подберут самый качественный и удобный способ восстановления сияющей улыбки.
                    </div>
                </div>

                <div class="page-content__chapter">
                    <div class="page-content__title">Протезирование зубов металлокерамикой</div>
                    <div class="page-content__text">Самый популярный вид несъемного протезирования. Фарфоровая облицовка покрывает прочный металлический каркас из благородных металлов. Металлокерамика дает высокий эстетический результат при максимальной долговечности (до 15 лет и более). <br><br>
                        Фарфор ― идеальный материал для замещения недостающих зубных единиц. Восстановление зубного ряда омолаживает внешний вид, улучшает гигиену полости рта, снимает эстетический дискомфорт. Форма коронки точно соответствует натуральному зубу, ее цвет подбирается по желанию пациента максимально естественных оттенков.
                    </div>
                </div>

                <div class="page-content__chapter">
                    <div class="page-content__title">Безметалловая керамика</div>
                    <div class="page-content__text">Каркас коронки изготавливается из литьевой керамики. Она прочная, долговечная, выглядит абсолютно естественно. Коронки неотличимы от своих живых зубов, поскольку литье полностью повторяет их параметры. Протезирование безметалловой керамикой абсолютно безопасно, гипоаллергенно и рекомендовано для восстановления передних или боковых зубных единиц.
                    </div>
                </div>

                <div class="page-content__chapter">
                    <div class="page-content__title">Восстановление керамической вкладкой</div>
                    <div class="page-content__text">Реставрация сильно разрушенного зуба (потеря более 30% коронки), клиновидные дефекты или гипоплазия эмали с помощью пломб не дает нужного результата. Вкладки из керамики можно моделировать, повторяя утраченную форму зуба, они гораздо более прочные и долговечнее пломб, а цвет в точности совпадает с оставшейся частью зуба.
                    </div>
                </div>

                <div class="page-content__chapter">
                    <div class="page-content__title">Бюгельное протезирование зубов</div>
                    <div class="page-content__text">Устанавливаем съемные бюгельные протезы на микрозамках. Они отличаются удобством ношения и высоким качеством. Прочный и тонкий металлокаркас обеспечивает устойчивость конструкции. Крючки (кламмеры) в таком протезе отсутствуют и поэтому эстетический результат очень высокий. Протезы на микрозамках удобны и абсолютно незаметны визуально, их снимают только во время чистки ― на ночь снимать не нужно. <br><br>
                        Наша клиника предлагает множество вариантов протезирования зубов. Наличие своей лаборатории позволяет сделать работу быстро и качественно. Записаться на прием или задать вопросы можно, сделав заявку на нашем сайте. Подарите себе ослепительную улыбку в клинке «Зубки Всем».
