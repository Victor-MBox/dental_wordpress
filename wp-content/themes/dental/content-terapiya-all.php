<?php
/* 
Template Name: ТЕРАПИЯ - Общая информация
*/
?>
        ...
        <div class="page-content__container container">
            ...
            <section class="page-contetn__wrapper" id="content-page">
                ...
                <div class="page-content__chapter">
                    <div class="page-content__banner page-content__banner_terapiya">
                        <div class="page-content__name">Терапия <br>в "Зубки Всем" </div>
                    ...
                    <div class="page-content__text">Стоматологическая терапия это меры, направленные на диагностику и лечение заболеваний зубов, десен и слизистой полости рта. В нашей клинике вы можете пройти лечение кариеса, пульпита, пародонтоза, периодонтита, восстановить зубную эмаль и очистить зубы от отложений камня.
                    </div>
                </div>

                <div class="page-content__chapter">
                    <div class="page-content__title">Виды и симптомы заболеваний зуба</div>
                    <div class="page-content__text">Самое частое заболевание зубов – кариес. Он может протекать бессимптомно, когда небольшое пятно на эмали скрывает обширную полость разрушения. Иногда кариес проявляется повышенной чувствительностью эмали к горячей или холодной пище. Если лечение кариеса не провести вовремя, заболевание может перейти в пульпит и периодонтит. <br><br>
                        Симптомы пульпита:
                    </div>

                    <div class="page-content__list">
                        <ul>
                            <li>внезапно возникающая острая боль в зубе;</li>
                            <li>боль отдает в виски, подбородок, челюсти;</li>
                            <li>в больном зубе боль пульсирующая или ноющая;</li>
                        </ul>
                        <ul>
                            <li>непереносимость холодной или горячей пищи, напитков;</li>
                            <li>усиление боли в ночное время.</li>
                        </ul>
                    </div>

                    <div class="page-content__text">Боль при пульпите может на время стихать, но это не значит, что процесс остановился. При выраженном болевом синдроме в области зубов нужно немедленно обращаться к стоматологу. Пульпит лечат препаратами, вычищают полость зуба с последующей пломбировкой каналов. <br><br>
                        Промедление с обращением к врачу дает различные осложнения:
                    </div>
                    ...
                    <div class="page-content__text">Распространение инфекции сопровождается воспалением десен, появлением гнилостного запаха изо рта. По кровеносным сосудам бактерии разносятся по организму, поражая в первую очередь такие органы, как почки и сердце.<br><br>
                        Своевременная терапия зубов позволяет сохранить их, не прибегая к удалению, предотвращает появление осложнений.<br><br>
                        Осмотр полости рта и рентген помогут поставить точный диагноз. Полость зуба очищается под местной анестезией и пораженные ткани удаляются. После чего проводится обработка противовоспалительными средствами и пломбирование любым видом пломбы по желанию пациента. Зуб реставрируют или протезируют, и он становится неотличим от здорового.
                    </div>
                </div>

                <div class="page-content__chapter">
                    <div class="page-content__title">Почему обращаются в «Зубки Всем»?</div>
                    <div class="page-content__text">Мы проводим качественную стоматологическую терапию взрослым и детям по доступным ценам. <br><br>
                    ...
                    <div class="page-about-section__advantages-wrapper">
                        <div class="page-about-section__advantages">
                            ...
                            <div class="page-about-section__advantages-text">высококвалифицированные <br> врачи</div>
                        </div>

                        <div class="page-about-section__advantages">
                            <img src="<?php echo bloginfo('template_url'); ?>/assets/img/icons/page/about/ic-about-02.svg" alt="">
                            <div class="page-about-section__advantages-text">индивидуальный подход к пациенту</div>
                        </div>

                        <div class="page-about-section__advantages">
                            <img src="<?php echo bloginfo('template_url'); ?>/assets/img/icons/page/about/ic-about-03.svg" alt="">
                            <div class="page-about-section__advantages-text"> передовое оборудование ведущих брендов</div>
                        </div>

                        <div class="page-about-section__advantages">
                            <img src="<?php echo bloginfo('template_url'); ?>/assets/img/icons/page/about/ic-about-04.svg" alt="">
                            <div class="page-about-section__advantages-text">высококачественные пломбировочные материалы</div>
                        </div>

                        <div class="page-about-section__advantages">
                            <img src="<?php echo bloginfo('template_url'); ?>/assets/img/icons/page/about/ic-about-05.svg" alt="">
                            <div class="page-about-section__advantages-text">комфортная атмосфера процедуры, под местной анестезией лучшими анестетиками</div>
                        </div>
