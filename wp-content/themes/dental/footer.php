...
<footer class="footer">
    <div class="container footer__container">
        ...
        <div class="footer__wrapper">
            ...
            <div class="footer__column">
                ...
                <div class="footer__item">
                    ...
                    <a href="tel:<?php the_field('footer_telefon', 'option'); ?>"><?php the_field('footer_telefon', 'option'); ?></a>
                </div>

                <div class="footer__item">
                    <div class="footer__img-map">
                    </div>
                    <a href="/kontakty/"><?php the_field('footer_adres', 'option'); ?></a>
                </div>

                <div class="footer__item">
                    <div class="footer__img-time">
                    </div>
                    <p><?php the_field('footer_vremya', 'option'); ?></p>
                </div>
        ...
        <div class="footer__policy">
            ...
            <a href="<?php the_field('ssylka_na_pdf', 'option'); ?>" target="blank">
                <?php the_field('footer_liczenziya', 'option'); ?>
            </a>
