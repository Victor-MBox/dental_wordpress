<?php
/* 
Template Name: ХИРУРГИЯ - Двухэтапная имплантация
*/
?>
            ...
            <section class="page-contetn__wrapper" id="content-page">
                ...
                <div class="page-content__chapter">
                    <div class="page-content__banner page-content__banner_implantatsiya">
                        <div class="page-content__name">Двухэтапная <br> имплантация</div>
                    ...
                    <div class="page-content__text">Классическая имплантация требует достаточного объема костной ткани, поэтому иногда требуется наращивание – костная пластика или синуслифтинг. На этапе диагностики стоматолог изучает состояние здоровья пациента, показания и противопоказания к имплантации. Проводится ортопантомография и КТ. Применяется 3D-моделирование этапов работы и подбираются имплантаты. Ротовая полость тщательно санируется и очищается от зубного камня.
                    </div>
                </div>
                ...
                <div class="page-content__chapter">
                    ...
                    <div class="page-content__list">
                        <ul>
                            <li>при недостатке костной ткани первым этапом будет ее наращивание, и затем заживление – несколько месяцев;</li>
                            <li>под местной анестезией врач надрезает десну, вкручивает имплантат и ставит на него заглушку;</li>
                            <li>ушивает десну;</li>
                            <li>приживление имплантата (до 6 месяцев);</li>
                            <li>установка формирователя десны для получения красивого контура (2 недели);</li>
                            <li>установка абатмента и закрепление постоянной коронки (металлокерамика, керамика, диоксид циркония).</li>
                        </ul>
                    </div>
                    <div class="page-content__text">Имплантация зубов ― надежный способ с высокой эстетикой, но достаточно затратный. Клиника «Зубки Всем» дает возможность оформить кредит или оплатить в рассрочку. После окончания имплантации, бонусом вы получаете контрольные осмотры стоматолога в течение года.
                    </div>
                </div>
