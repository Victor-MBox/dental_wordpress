<?php
/* 
Template Name: ПРОТЕЗИРОВАНИЕ - Виниры
*/
?>
        ...
        <div class="page-content__container container">
            ...
            <section class="page-contetn__wrapper" id="content-page">
                ...
                <div class="page-content__chapter">
                    <div class="page-content__banner page-content__banner_viniry">
                        <div class="page-content__name">Виниры</div>
                    ...
                    <div class="page-content__text">Виниры для зубов делают улыбку «голливудской», скрывая внешние дефекты зубов. Прочные накладки из циркония, фарфора, керамики, фотополимеров выглядят естественно и эстетически привлекательно. Зубы становятся белее, скрываются дефекты на эмали и межзубные промежутки. «Зубки Всем» проводит коррекцию зубов фронтальной зоны передовыми качественными материалами, мы гарантируем идеальную улыбку нашим пациентам.
                    </div>
                </div>

                <div class="page-content__chapter">
                    <div class="page-content__title">Рекомендации к установке виниров</div>
                    <div class="page-content__text">Накладки исправляют различные дефекты зубов в зоне улыбки. От каких недостатков избавляются наши пациенты:
                    </div>
                    <div class="page-content__list">
                        <ul>
                            <li>неэстетичный желтый цвет эмали;</li>
                            <li>большие межзубные промежутки;</li>
                            <li>пятна на эмали или темный цвет после депульпации;</li>
                        </ul>
                        <ul>
                            <li>трещины, сколы, эрозия эмали;</li>
                            <li>если не устраивает форма зуба;</li>
                            <li>восстановление внешнего вида после некачественной реставрации.</li>
                        </ul>
                    </div>
                    <div class="page-content__text">Виниры можно ставить в зоне верхней или нижней челюсти, корректируя один или несколько зубных единиц. Для достижения высокого эстетического результата стоматологи рекомендуют восстановить всю зону улыбки.</div>
                </div>

                <div class="page-content__chapter">
                    <div class="page-content__title">Преимущества виниров</div>
                    <div class="page-content__text">Виниры делают зубы красивыми, устраняют переживания по поводу их недостатков, без протезирования, не нанося зубам ущерба. <br><br>
                        Основные преимущества виниров :
                    </div>
                    <div class="page-content__list">
                        <ul>
                            <li>быстрый результат, для установки достаточно 2-3 посещений;</li>
                            <li>простой уход – обычная чистка зубов;</li>
                            <li>долгий срок службы в зависимости от используемых материалов ― от 3 до 20 лет;</li>
                            <li>большой выбор цветов и оттенков по желанию пациента;</li>
                            <li>слой снимаемой зубной эмали составляет доли миллиметра и не вредит зубам.</li>
                        </ul>
                    </div>
                    <div class="page-content__text">Виниры сохраняют зубы здоровыми, их плотное прилегание защищает дентин от повреждающих факторов.</div>
                </div>

                <div class="page-content__chapter">
                    <div class="page-content__title">Установка виниров в Москве</div>
                    <div class="page-content__text">Клинка «Зубки Всем» изготавливает виниры из фарфора, диоксида циркония, стеклокерамики или фотокомпозитов. Выбор зависит от индивидуальных особенностей и пожеланий пациента. Наша лаборатория Alvadent входит в ТОП-10 по Москве. Сделаем вашу улыбку ослепительной, а настроение прекрасным. Записаться на консультацию или заказать звонок можно на нашем сайте – специалисты моментально перезвонят и подробно проконсультируют вас по всем интересующим вопросам.
                    </div>
                </div>
