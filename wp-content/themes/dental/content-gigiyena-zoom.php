<?php
/* 
Template Name: ГИГИЕНА И ОТБЕЛЕВАНИЕ - Отбеливание ZOOM
*/
?>
        ...
        <div class="page-content__container container">
            ...
            <section class="page-contetn__wrapper" id="content-page">
                ...
                <div class="page-content__chapter">
                    <div class="page-content__banner page-content__banner_zoom">
                        <div class="page-content__name">Отбеливание</div>
                    ...
                    <div class="page-content__text">Белые зубы всегда считались показателем здоровья, статуса и красоты. Природный цвет эмали у многих людей имеет желтоватый или сероватый оттенок. Употребление кофе, некоторых лекарств, курение дополнительно ухудшают цвет зубов. <br><br>
                        Современная технология отбеливание последнего поколения использует свойства специального геля, распадающегося под действием УФ-лучей с образованием атомов кислорода.
                        Живительный кислород проникает в эмаль и дентин, растворяя красящие пигменты.
                    </div>
                </div>

                <div class="page-content__chapter">
                    <div class="page-content__title">Преимущества отбеливания</div>
                    <div class="page-content__text">Процедура занимает достаточно мало времени, абсолютно безболезненна и комфортна.
                        <br><br>
                        <b>Ее несомненными достоинствами являются:</b>
                    </div>

                    <div class="page-content__list">
                        <ul>
                            <li>наличие в гелях фосфата кальция, укрепляющего эмаль;</li>
                            <li>несколько режимов работы регулируют нужную степень воздействия;</li>
                            <li>за час можно отбелить зубы на 5-7 тонов;</li>
                            <li>результат сохраняется несколько лет (3-5);</li>
                        </ul>
                        <ul>
                            <li>безопасна для эмали;</li>
                            <li>исключен перегрев пульпы и десен;</li>
                            <li>убирает окраску на «тетрациклиновых» зубах.</li>
                        </ul>
                    </div>

                    <div class="page-content__text">На приеме врач и пациент определяют желаемый оттенок эмали по шкале VITA. На лицо пациента наносится крем с защитой от ультрафиолета. Десны и глаза тоже защищаются. Обычно, для получения белоснежной улыбки достаточно 1-2 нанесений. После процедуры зубы обрабатывают реминерализующим составом. <br><br>
                        Зубки Всем предлагает обрести голливудскую улыбку с помощью наших профессионалов, в комфортной обстановке, по доступной цене.
                    </div>
                </div>
