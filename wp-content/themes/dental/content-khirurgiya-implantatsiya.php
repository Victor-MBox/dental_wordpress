<?php
/* 
Template Name: ХИРУРГИЯ - Имплантация
*/
?>
        ...
        <div class="page-content__container container">
            ...
            <section class="page-contetn__wrapper" id="content-page">
                ...
                <div class="page-content__chapter">
                    <div class="page-content__banner page-content__banner_implantatsiya">
                        <div class="page-content__name">Имплантация</div>
                        <div class="page-content__label">от <span>3 500₽</span></div>
                    ...
                    <div class="page-content__text">Многокорневые зубы, переплетение корней, анатомическая патология (особенно у восьмерок), отсутствие коронки требует дополнительных инструментов и особой техники проведения процедуры.
                        <br><br>
                        <b>Показания к сложному удалению:</b>
                    </div>
                    <div class="page-content__list">
                        <ul>
                            <li>8-ки и другие зубы с боковым положением в десне;</li>
                            <li>неоперабельные кисты;</li>
                            <li>осколки зубов после травмы;</li>
                            <li>ретинированные, дистопированные, сильно разрушенные единицы.</li>
                        </ul>
                    </div>
                    <div class="page-content__text">Сложное удаление может продолжаться 1-1.5 часа иногда дольше. Перед вмешательством нужно купировать воспалительный процесс в зубе, при необходимости проводим чистку.
                    </div>
                </div>
                ...
                <div class="page-content__chapter">
                    ...
                    <div class="page-content__list">
                        <ul>
                            <li>планирование с помощью осмотра и рентгеновского снимка;</li>
                            <li>обезболивание;</li>
                            <li>вскрытие десны и отделение слизистой от костной ткани</li>
                            <li>медленная, осторожная экстракция зуба или его обломков;</li>
                            <li>очищение и обработка раны антисептиком;</li>
                            <li>ушивание десны.</li>
                        </ul>
                    </div>
                    <div class="page-content__text">Сложное удаление требует повторного посещения хирурга-стоматолога для снятия швов (если они не саморассасывающиеся) и тщательного осмотра.
                    </div>
                </div>

                <div class="page-content__chapter">
                    <div class="page-content__title">Почему « Зубки Всем»?</div>
                    <div class="page-content__text">Клиника имеет большой опыт проведения таких операций. Диагностику проводим на передовом оборудовании в день обращения. Весь инструментарий и расходные материалы только ведущих мировых брендов. При необходимости удалить зуб цена в нашей клинике вас приятно удивит. Наши врачи обладают большим опытом и операции проходят без осложнений с быстрым периодом реабилитации. По всем вопросам можно оставить заявку на нашем сайте или позвонить по указанным телефонам.
                    </div>
                </div>
                ...
                <div class="page-content__chapter">
                    <div class="page-content__infobox">
                        Имплантация «под ключ». <br>Система имплантации OSSTEM. Стоимость 45000₽ вместо 75000₽. <br>Возможна рассрочка от банков партнеров.
                        </div>
                </div>
                ...
                <div class="page-content__chapter">
                    ...
                    <table class="table-service">
                        <tr>
                            <td class="table-service__name">Внутрикостная дентальная имплантация “Neo Dent” (Швейцария)</td>
                            <td class="table-service__price">3 500 ₽</td>
                        </tr>
                        <tr>
                            <td class="table-service__name">Внутрикостная дентальная имплантация “Osstem” (Корея)</td>
                            <td class="table-service__price">30 000 ₽</td>
                        </tr>
                        <tr>
                            <td class="table-service__name">Внутрикостная дентальная имплантация “Astra” (Швеция)</td>
                            <td class="table-service__price">60 000 ₽</td>
                        </tr>
                    </table>
