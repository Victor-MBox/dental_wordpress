<?php
/* 
Template Name: ДИАГНОСТИКА - Общая информация
*/
?>
        ...
        <div class="page-content__container container">
            ...
            <section class="page-contetn__wrapper" id="content-page">
                ...
                <div class="page-content__chapter">
                    <div class="page-content__banner page-content__banner_diagnostika">
                        <div class="page-content__name">Консультации <br>и диагностика <br>в "Зубки Всем" </div>
                        <div class="page-content__label">от <span>0₽</span></div>
                    ...
                    <div class="page-content__text">Прежде чем приступить к лечению, необходимо максимально точно изучить состояние полости рта, выявив скрытые патологии. Современная диагностика зубов позволяет полностью контролировать процесс лечения, видеть его промежуточные и окончательные результаты. Клиника «ЗубкиВсем» предлагает пройти полную диагностику на первом приеме.
                    </div>
                </div>

                <div class="page-content__chapter">
                    <div class="page-content__title">Показания</div>
                    <div class="page-content__text">Диагностика состояния костной ткани необходима перед проведением имплантации. Рентген и КТ покажут объем и плотность кости, выявят воспаления, гранулемы или кисты. При необходимости, имплантолог выполнит костную пластику, и тогда импланты будут сидеть безупречно, а голливудская улыбка радовать вас и окружающих десятки лет. <br> <br>
                        Стоматолог-терапевт использует рентген для эндодонтического лечения, чтобы качественно очистить, вылечить каналы и проверить установку пломбы. Зуб удается сохранить надолго без протезирования.
                        Хирург с помощью снимка определяет, какой зуб можно сохранить, а какой подлежит удалению. Врач-ортодонт исследует положение зубов в челюсти, контролирует процесс исправления прикуса.
                    </div>
                </div>

                <div class="page-content__chapter">
                    <div class="page-content__title">Виды диагностики</div>
                    <div class="page-content__text">Клиника располагает самым современным оборудованием для полноценного обследования. <br><br>
                        Основные виды диагностики зубов: <br><br>
                        <div class="page-content__list">
                            <ul>
                                <li>прицельный снимок;</li>
                                <li>панорамный снимок обеих челюстей (ортопантомография);</li>
                                <li>3-D компьютерная томография.</linstyle=>
                            </ul>
                        </div>
                    </div>
                    <div class="page-content__text">Цифровые аппараты последнего поколения – ортопантомограф и компьютерный томограф компании SOREDEX безопасны в плане лучевой нагрузки. Наши ортодонты анализируют прикус современным прибором Т-scan. Оборудование клиники позволяет полностью обследовать зубочелюстную систему пациентов <br><br>
                        Цена диагностики зубов указана в прайсе. При прохождении комплексного лечения многие обследования в клинике выполняются бесплатно. Запишитесь на диагностику онлайн и пройдите ее в любое удобное для вас время.
                    </div>
                </div>
