<?php
/* 
Template Name: ГИГИЕНА И ОТБЕЛЕВАНИЕ - Профессиональная чистка AirFlow
*/
?>
        ...
        <div class="page-content__container container">
            ...
            <section class="page-contetn__wrapper" id="content-page">
                ...
                <div class="page-content__chapter">
                    <div class="page-content__banner page-content__banner_airflow">
                        <div class="page-content__name">Профессиональная <br> чистка AirFlow</div>
                        <div class="page-content__label">от <span>₽</span></div>
                    ...
                    <div class="page-content__text">Открытая, сияющая улыбка вызывает симпатию окружающих и дарит человеку чувство уверенности. <br><br>
                        Со временем, несмотря на тщательный уход за зубами, на них появляется налет. Этому способствует употребление чая, кофе, красящих специй или красного вина и особенно курение. Профессиональная чистка зубов решает проблему налета быстро и качественно. <br><br>
                        Передовая методика AirFlow в клинике «Зубки Всем» применяется для удаления налета, зубного камня, при подготовке к ортодонтическому лечению или имплантации. Процедура не требует анестезии, безболезненна, проводится раз в полгода или ежегодно.
                    </div>
                </div>

                <div class="page-content__chapter">
                    <div class="page-content__title">Что такое метод AirFlow</div>
                    <div class="page-content__text">Деликатная процедура проводится бесконтактным способом. Струя воздуха с водой и микрочастицами соды тщательно очищает зубы до естественного цвета, убирая налет и отложения микробов. <br><br>
                        <b>Показания к AirFlow:</b>
                    </div>

                    <div class="page-content__list">
                        <ul>
                            <li>для диагностики межзубного кариеса;</li>
                            <li>перед пломбированием и отбеливанием зубов;</li>
                        </ul>
                        <ul>
                            <li>в процессе лечения у ортодонта;</li>
                            <li>перед имплантацией.</li>
                        </ul>
                    </div>

                    <div class="page-content__text">Процедура противопоказана людям с бронхо-легочными заболеваниями из-за возможного затруднения дыхания.
                    </div>
                </div>

                <div class="page-content__chapter">
                    <div class="page-content__title">Преимущества AirFlow</div>

                    <div class="page-content__list">
                        <ul>
                            <li>процедура сопровождается подачей на поверхность эмали фторсодержащих препаратов для профилактики кариеса и укрепления эмали;</li>
                            <li>пигментация удаляется без повреждения эмали;</li>
                            <li>состав не содержит абразивов;</li>
                            <li>тщательно очищаются межзубные промежутки и фиссуры, недоступные при обычной чистке.</li>
                        </ul>
                    </div>

                    <div class="page-content__text">Стоимость чистки Air Flow абсолютно доступна. Наши пациенты проходят Эйр Флоу дважды в год и не имеют проблем с заболеваниями зубов. Вы можете записаться на процедуру на нашем сайте в любое удобное время. Сделайте вашу улыбку совершенной!
                    </div>
                </div>
