...
function SimpleChatbot(config) {
  ...
  this._url = config['url']
		? config['url']
		: 'http://localhost:8888/Dental/wp-content/themes/dental/assets/simplechatbot/chatbot/chatbot.php'
...
SimpleChatbot.prototype._templateBtn = function (botIndex, content) {
  return '<button class="btn-chatbot" type="button" data-bot-index="' + botIndex + '">' + content + '</button>';
};
...
SimpleChatbot.resetTemplate = function() {
  ...
  $root.innerHTML =
		'<div class="chatbot__title"><span class="chatbot__close"></span><span class="chatbot__title-name">🤖 ЗубкиБот</span><span class="chatbot__reset"></span></div><div class="chatbot__wrapper"><div class="chatbot__items"></div></div><div class="chatbot__footer"><input class="chatbot__input" type="text" disabled><button class="chatbot__submit" type="button" disabled></button></div> <div class="chatbot__footer-developer"><a href="https://creators-group.ru/"><img src="http://localhost:8888/Dental/wp-content/themes/dental/assets/img/icons/poweredBy.svg" alt=""> Powered by <span> Creators Group</span></a></div>'
};
