<?php
/* 
Template Name: ПРОТЕЗИРОВАНИЕ - Акриловые протезы
*/
?>
            ...
            <section class="page-contetn__wrapper" id="content-page">
                ...
                <div class="page-content__chapter">
                    <div class="page-content__banner page-content__banner_akrilovyye">
                        <div class="page-content__name">Акриловые <br>протезы</div>
                        <div class="page-content__label">от <span>12 000₽</span></div>
                    ...
                    <div class="page-content__text">Съемное протезирование акриловой конструкцией ― популярный и доступный способ восстановить недостающие зубы. Из акрила изготавливается основа протеза, имитирующая края десен, на нее посажены искусственные зубы из акрила или керамики. Опытные ортопеды и специалисты собственной лаборатории клиники «Зубки Всем» быстро и недорого изготавливают удобные конструкции с учетом особенностей челюсти пациента.
                    </div>
                </div>

                <div class="page-content__chapter">
                    <div class="page-content__title">Какие бывают акриловые протезы зубов</div>
                    <div class="page-content__text">Полные съемные акриловые протезы изготавливают при полном отсутствии зубов на челюсти. На верхней челюсти они фиксируются за счет эффекта присасывания, на нижней опираются на альвеолярные отростки. <br><br>
                        Что касается частичных акриловых протезов, то они используются, когда есть несколько своих зубов, служащих опорой. Конструкция закрепляется на них кламмерами (специальными крючками).
                    </div>
                </div>

                <div class="page-content__chapter">
                    <div class="page-content__title">Достоинства</div>
                    <div class="page-content__text">К несомненным достоинствам этого вида протезирования относятся следующие моменты:<br><br>
                        <div class="page-content__list">
                            <ul>
                                <li>акриловые протезы зубов легко надевать и снимать;</li>
                                <li>низкая цена;</li>
                                <li>удовлетворительная эстетика;</li>
                                <li>возможность ремонта;</li>
                            </ul>
                            <ul>
                                <li>достаточная износостойкость;</li>
                                <li>быстрота изготовления;</li>
                                <li>удобство после привыкания;</li>
                                <li>устойчивость к химическим веществам – акрил не меняет цвет.</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="page-content__chapter">
                    <div class="page-content__title">Недостатки</div>
                    <div class="page-content__text">Наряду с достоинствами такие конструкции имеют особенности, которые подойдут не всем пациентам: <br><br>
                        <div class="page-content__list">
                            <ul>
                                <li>частичное перекрытие неба может мешать вкусовым ощущениям;</li>
                                <li>иногда они натирают десны;</li>
                                <li>на мономеры акрила может возникать аллергия;</li>
                                <li>пористый материал протеза может накапливать бактериальную микрофлору, необходима тщательная очистка;</li>
                                <li>длительный период адаптации пациента.</li>
                            </ul>
                        </div>
                        <div class="page-content__text">Акриловые протезы зубов хороший недорогой способ восстановления жевательной функции и эстетики. Если он вам не подходит, можно рассмотреть другие варианты.</div>
                    </div>
                </div>

                <div class="page-content__chapter">
                    <div class="page-content__title">Альтернативные методики протезирования</div>
                    <div class="page-content__text">Клиника «Зубки Всем» устанавливает различные виды съемных и несъемных протезов:<br><br>
                        <div class="page-content__list">
                            <ul>
                                <li>съемные нейлоновые протезы, конструкции Акри Фри или Квадротти;</li>
                                <li>мостовидные;</li>
                            </ul>
                            <ul>
                                <li>бюгельные;</li>
                        ...
                        <div class="page-content__text">Выбор зависит от пожеланий пациента, индивидуальных особенностей ротовой полости и финансовых возможностей. Кроме того, подбор метода протезирования основывается на медицинских показаниях. Высококвалифицированные врачи нашей клиники проконсультируют и посоветуют наиболее подходящий вам вариант протезирования высокого качества и по доступной цене. Связаться с нами можно, заполнив заявку на сайте или позвонив по телефону.</div>
                    </div>
                </div>
