<?php
/* 
Template Name: ХИРУРГИЯ - Одномоментная имплантация
*/
?>
        ...
        <div class="page-content__container container">
            ...
            <section class="page-contetn__wrapper" id="content-page">
                ...
                <div class="page-content__chapter">
                    <div class="page-content__banner page-content__banner_implantatsiya-odnomoment">
                        <div class="page-content__name">Одномоментная <br> имплантация</div>
                    ...
                    <div class="page-content__text">Установка имплантата сразу после удаления зуба удобна для пациента, сокращает время лечения и денежные расходы.
                        <br><br>
                        <b>Показания:</b>
                    </div>
                    <div class="page-content__list">
                        <ul>
                            <li>зубы, однозначно подлежащие удалению;</li>
                            <li>отсутствие воспаления;</li>
                            <li>отсутствие дефицита костной ткани, кист или пародонтита;</li>
                            <li>не имеется противопоказаний по состоянию здоровья.</li>
                        </ul>
                    </div>
                    <div class="page-content__text">Перед процедурой делается рентгенодиагностика, санируется полость рта.
                    </div>
                </div>
                ...
                <div class="page-content__chapter">
                    ...
                    <div class="page-content__list">
                        <ul>
                            <li>аккуратное, без повреждения костной ткани удаление зуба;</li>
                            <li>хирург формирует в зубной лунке ложе для имплантата, добавляет искусственную костную ткань;</li>
                            <li>вживляет имплантат и ушивает десну;</li>
                            <li>устанавливает на имплантат временную коронку.</li>
                        </ul>
                    </div>
                    <div class="page-content__text">Через несколько месяцев, когда произойдет полное приживление, временная коронка меняется на постоянную.
                    </div>
                </div>
