<?php
/* 
Template Name: ТЕРАПИЯ - Лечение зубных каналов
*/
?>
        ...
        <div class="page-content__container container">
            ...
            <section class="page-contetn__wrapper" id="content-page">
                ...
                <div class="page-content__chapter">
                    <div class="page-content__banner page-content__banner_kanaly">
                        <div class="page-content__name">Лечение зубных <br>каналов</div>
                    ...
                    <div class="page-content__text">Термин эндодонтическая терапия переводится как лечение зубных каналов. Внутри зуба расположена пульпа – сосудисто-нервный пучок. Глубокий кариес постепенно разрушает ткань зуба, и микробы проникают в пульпу, вызывая ее воспаление, при этом пациент ощущает острую боль. Спасти зуб в такой ситуации может только лечение корневых каналов.
                    </div>
                </div>

                <div class="page-content__chapter">
                    <div class="page-content__title">Показания к лечению зубных каналов</div>
                    <div class="page-content__text">Основные причины, приводящие пациента в кресло стоматолога для эндодонтического лечения, это запущенный кариес, приводящий к пульпиту, травма зуба или заболевания пародонта. <br><br>
                        <b>Симптомы, которые дают понять, что необходимо срочное лечение:</b>
                    </div>

                    <div class="page-content__list">
                        <ul>
                            <li>боль в зубе, усиливающаяся при прикосновении;</li>
                            <li>реакция на холодную или горячую пищу и напитки;</li>
                            <li> десна может быть болезненна и отечна, начинает формироваться флюс;</li>
                            <li>появление неприятного запаха изо рта.</li>
                        </ul>
                    </div>

                    <div class="page-content__text">
                        Такая симптоматика означает, что нервы и сосуды пульпы в стадии воспаления или уже погибли. Для сохранения зуба необходимо вычистить его от пораженных тканей и запломбировать.
                    </div>
                </div>

                <div class="page-content__chapter">
                    <div class="page-content__title">Этапы лечения</div>
                    <div class="page-content__text">Количество корневых каналов достигает 4-х в разных зубных единицах. Они могут быть неправильной формы, извитые, и требуется большое мастерство стоматолога, чтобы тщательно вылечить и затем восстановить зуб в его первозданном виде. Стоматологи нашей клиники имеют специализацию по эндодонтическому лечению, высочайшую квалификацию и индивидуальный подход к пациенту. <br><br>
                        <b>Из каких этапов складывается лечение:</b>
                    </div>

                    <div class="page-content__list">
                        <ul>
                            <li>проводится рентгенологическая диагностика состояния зуба;</li>
                            <li>врач применяет местную анестезию, процедура проходит абсолютно комфортно и безболезненно;</li>
                            <li>удаляется кариес;</li>
                            <li>вычищается пораженная микробами пульпа;</li>
                            <li>канал обрабатывается антисептиками;</li>
                            <li>если пульпит уже перешел в периодонтит, то в каналы закладывается временная пломба с лечебными препаратами;</li>
                            <li>окончательное пломбирование и герметичное закрытие зубного канала.</li>
                        </ul>
                    </div>

                    <div class="page-content__text">Дальнейшее восстановление зуба зависит от степени его сохранности. При небольших, до 30% разрушениях коронки проводят реставрацию световой пломбой. Если степень повреждения значительная, можно поставить керамическую вкладку или коронку из металлокерамики или других материалов. <br><br>
                        Клинка «Зубки Всем» в Москве проводит лечение зубных каналов на высоком уровне по доступным ценам. Избавим от боли, воспаления, сохраним зуб. Консультация бесплатно, диагностика в день обращения. Узнать информацию, проконсультироваться и записаться на лечение можно на нашем сайте.
                    </div>
                </div>
