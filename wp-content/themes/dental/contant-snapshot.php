        ...
        <div class="page-content__container container">
            ...
            <section class="page-contetn__wrapper" id="content-page">
                ...
                <div class="page-content__chapter">
                    <div class="page-content__banner page-content__banner_snapshot">
                        <div class="page-content__name">Прицельный <br> снимок</div>
                    ...
                    <div class="page-content__text">Рентген зуба ― базовое информативное и самое частое стоматологическое обследование. Современный цифровой рентгеновский аппарат (радиовизиограф) позволяет выводить картину на монитор и рассматривать ее в увеличении. Врач-стоматолог видит ту часть зуба, которая скрыта под тканью десны и в кости челюсти. Рентген помогает быстро поставить точный диагноз и приступить к лечению. <br><br>
                        Прицельный снимок зубов покажет повреждения корней, пульпит, периодонтит, кисты, новообразования, состояние зубного канала или пломбы, находящейся в нем. Аппаратура позволяет визуализировать и соседние зубы (до 4 зубов на одном снимке). Высокое разрешение обеспечивает максимальную точность диагностики.
                    </div>
                </div>

                <div class="page-content__chapter">
                    <div class="page-content__title">Показания для прицельного снимка зубов</div>
                    <div class="page-content__text">Рентген может понадобиться на любом этапе – диагностика и лечение, а также последующий контроль. <br><br>
                        Прицельный рентген необходим в следующих ситуациях:
                    </div>

                    <div class="page-content__list">
                        <ul>
                            <li style="font-weight: 400; color: #697492;">экстракция (удаление) зуба, особенно в сложных случаях или при наличии нескольких корней;</li>
                            <li style="font-weight: 400; color: #697492;"> эндодонтические манипуляции (лечение каналов и закрытие их пломбой);</li>
                            <li style="font-weight: 400; color: #697492;">диагностика и лечение кариеса, пульпита, периодонтита, периостита и др.;</linstyle=>
                            <li style="font-weight: 400; color: #697492;">перед одномоментной имплантацией ― чтобы удалить зуб максимально щадящее, не повредив альвеолярный отросток;</li>
                            <li style="font-weight: 400; color: #697492;">исправление прикуса.</li>
                        </ul>
                    </div>
                </div>

                <div class="page-content__chapter">
                    <div class="page-content__title">Преимущества снимка на радиовизиографе</div>
                    <div class="page-content__text">Лучевая нагрузка современных цифровых рентген-аппаратов минимальна и равна радиационному фону окружающей среды. В процессе лечения прицельный снимок безопасно делать несколько раз для контроля. <br><br>
                        Преимущества прицельного рентгена:</div>
                    <div class="page-content__column-wrapper">
                        <div class="page-content__list">
                            <ul>
                                <li style="font-weight: 500; color: #697492;">безопасность;</li>
                                <li style="font-weight: 500; color: #697492;">быстрота;</li>
                                <li style="font-weight: 500; color: #697492;">универсальность при многих стоматологических патологиях;</li>
                            </ul>
                            <ul>
                                <li style="font-weight: 500; color: #697492;">детальная четкая информация;</li>
                                <li style="font-weight: 500; color: #697492;">возможность увеличения;</li>
                                <li style="font-weight: 500; color: #697492;">возможность хранения на носителе.</li>
                            </ul>
                        </div>
                    </div>

                    <div class="page-content__text">Прицельный снимок не имеет противопоказаний. Исключение – I триместр беременности, когда от любых рентген-обследований лучше воздержаться, если нет срочной необходимости.</div>
                </div>

                <div class="page-content__chapter">
                    <div class="page-content__title">Сделать прицельный снимок зубов в «Зубки Всем»</div>
                    <div class="page-content__text">Врачи нашей клиники работают на передовом современном рентгенологическом оборудовании. Быстрая диагностика проблемы поможет провести правильное лечение. Пациент может обратиться в любое удобное время, процедура займет не более 15-20 минут. Цену на рентген зуба вы сможете узнать в нашем прайсе, а дополнительные вопросы задать по телефону, указанному на сайте.</div>
                </div>
