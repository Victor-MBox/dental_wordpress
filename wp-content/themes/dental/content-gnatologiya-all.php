<?php
/* 
Template Name: ГНАТОЛОГИЯ - Общая информация
*/
?>
        ...
        <div class="page-content__container container">
            ...
            <section class="page-contetn__wrapper" id="content-page">
                ...
                <div class="page-content__chapter">
                    <div class="page-content__banner page-content__banner_gnatologiya">
                        <div class="page-content__name">Гнатология <br>в "Зубки Всем" </div>
                    ...
                    <div class="page-content__text">Гнатология – наука изучающая работу зубочелюстной системы, ее норму и патологию, поскольку жевательная функция является жизненно важной для организма. Врач-гнатолог это стоматолог, который занимается диагностикой и лечением патологий височно-нижнечелюстного сустава (ВСНЧ).
                    </div>
                </div>

                <div class="page-content__chapter">
                    <div class="page-content__title">Когда надо обратиться к гнатологу</div>
                    <div class="page-content__text">Если не учитывать гнатологичнские принципы и игнорировать характерные симптомы, то можно получить неудовлетворительные результаты при протезировании, имплантации или ортодонтичнском лечении. <br><br>
                        Патология ВСНЧ может приводить к неправильной нагрузке зубных единиц и челюсти, неполному смыканию зубов, появлению дискомфорта или челюстных патологий. <br><br>
                        <b>Симптомы, говорящие о том, что нужна помощь гнатолога:</b>
                    </div>
                    <div class="page-content__list">
                        <ul>
                            <li>боль в ушах или их закладывание;</li>
                            <li>появление щелкающего звука при движении челюстей;</li>
                            <li>бруксизм;</li>
                            <li>ощущение дискомфорта после имплантации или установки протезов;</li>
                            <li>боли в мышцах лица и шеи.</li>
                        </ul>
                    </div>
                </div>

                <div class="page-content__chapter">
                    <div class="page-content__title">Диагностика в гнатологии</div>
                    <div class="page-content__text">Исследование ВНЧС является приоритетом в диагностике. Применяется ортопатомография, компьютерная томография сустава. С помощью миографии исследуется жевательные мышцы, а также причины нарушения смыкания зубов. <br><br>
                        Для точной диагностики и лечения патологии ВСНЧ применяется метод компьютерного моделирования. Разработка программ коррекции и оптимальных методик лечения тоже являются задачей гнатологии.
                    </div>
                </div>
