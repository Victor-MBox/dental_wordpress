<?php
/* 
Template Name: ХИРУРГИЯ - Удаление зубов
*/
?>
        ...
        <div class="page-content__container container">
            ...
            <section class="page-contetn__wrapper" id="content-page">
                ...
                <div class="page-content__chapter">
                    <div class="page-content__banner page-content__banner_udaleniye">
                        <div class="page-content__name">Удаление <br>зубов</div>
                    ...
                    <div class="page-content__text">Экстракция (удаление) зуба иногда является единственным решением, если зубную единицу уже нельзя сохранить. <br><br>
                    ...
                    <div class="page-content__text">Удаление в «Зубки Всем» проводят хирурги с большим опытом. Безболезненная и быстрая процедура проходит под анестезией. Хирург-стоматолог извлекает зуб из лунки щипцами, затем проводится антисептическая обработка и наложение швов при необходимости.
                    </div>
                </div>
