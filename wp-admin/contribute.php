...
<div class="wrap about__container">
	...
	<div class="about__section has-2-columns is-wider-right">
		<div class="column about__image">
			<img src="<?php echo esc_url( admin_url( 'images/contribute-main.svg?ver=6.3' ) ); ?>" alt="" loading="lazy" />
		</div>
	...
	<div class="about__section has-2-columns is-wider-left">
		...
		<div class="column">
			<img src="<?php echo esc_url( admin_url( 'images/contribute-no-code.svg?ver=6.3' ) ); ?>" alt="" loading="lazy" />
		</div>
	</div>
	<div class="about__section has-2-columns is-wider-right">
		<div class="column">
			<img src="<?php echo esc_url( admin_url( 'images/contribute-code.svg?ver=6.3' ) ); ?>" alt="" loading="lazy" />
		</div>
		<div class="column is-vertically-aligned-center">
