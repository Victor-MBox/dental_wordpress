...
<div class="theme<?php echo $active_class; ?>">
	<?php if ( ! empty( $theme['screenshot'][0] ) ) { ?>
		<div class="theme-screenshot">
			<img src="<?php echo esc_url( $theme['screenshot'][0] . '?ver=' . $theme['version'] ); ?>" alt="" loading="lazy" />
		</div>
	<?php } else { ?>
...
<script id="tmpl-theme" type="text/template">
	<# if ( data.screenshot[0] ) { #>
		<div class="theme-screenshot">
			<img src="{{ data.screenshot[0] }}?ver={{ data.version }}" alt="" loading="lazy" />
		</div>
	<# } else { #>
		<div class="theme-screenshot blank"></div>
	<# } #>
...
<script id="tmpl-theme-single" type="text/template">
	...
	<div class="theme-wrap wp-clearfix" role="document">
		...
		<div class="theme-about wp-clearfix">
			...
			<# if ( data.screenshot[0] ) { #>
				<div class="screenshot"><img src="{{ data.screenshot[0] }}?ver={{ data.version }}" alt="" loading="lazy" /></div>
			<# } else { #>
